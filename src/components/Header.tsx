export default function Header() {
  return (
    <div className="fixed w-full z-[100] bg-white text-white font-extrabold text-3xl py-2 px-4 flex justify-between items-center shadow-sm">
      ...
      <a
        href="https://github.com/bdgrichards/zenith"
